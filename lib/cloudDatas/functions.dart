...
class wantsData extends StatefulWidget {
  const wantsData({Key? key}) : super(key: key);

  @override
  State<wantsData> createState() => _wantsDataState();
}

class _wantsDataState extends State<wantsData> {
                                ...
                                child: Column(children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text('${docSnap[index]["subject"]}',softWrap: true, overflow:TextOverflow.clip,
                                        style: const TextStyle(fontWeight: FontWeight.w400,fontSize: 15,overflow: TextOverflow.clip,)),
                                  ),
